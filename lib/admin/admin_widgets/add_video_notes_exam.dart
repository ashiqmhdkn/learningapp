...
class AddVideoNotesExam extends ConsumerStatefulWidget {
  const AddVideoNotesExam({super.key});

  @override
  ConsumerState<AddVideoNotesExam> createState() => _AddVideoNotesExamState();
}

class _AddVideoNotesExamState extends ConsumerState<AddVideoNotesExam> {
  String courseImage = "";
